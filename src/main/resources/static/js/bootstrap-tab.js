...
(function ($, window, document, undefined) {
    ...
    BaseTab.prototype.template = {
        ...
        ul_li_close: '<i class="glyphicon glyphicon-remove" title="关闭"></i>',
    ...
    BaseTab.prototype.loadData = function () {
        ...
        //关闭tab事件
        this.$element.find(".nav-tabs li a i.glyphicon-remove").each(function (index, item) {
        	$(item).css({"width":"10px","height":"10px"})
            $(item).click(function () {
